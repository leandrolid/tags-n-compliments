    ...
    function CreateUserService() {
        ...
        this.execute = function (_a) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                var userRepository, userAlreadyExists, passwordHash, newUser;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            userRepository = typeorm_1.getCustomRepository(UserRepositories_1.UserRepositories);
                            if (!email || !password) {
                        ...
                        case 3:
                            _b.sent();
                            return [2 /*return*/, __assign(__assign({}, newUser), { password: undefined })];
                    }
                });
            });
        };
