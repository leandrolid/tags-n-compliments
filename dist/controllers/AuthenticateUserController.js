...
var AuthenticateUserController = /** @class */ (function () {
    ...
    AuthenticateUserController.prototype.handle = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, email, password, createAuthService, token;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = request.body, email = _a.email, password = _a.password;
                        createAuthService = new AuthenticateUserService_1.AuthenticateUserService();
                        return [4 /*yield*/, createAuthService.execute({ email: email, password: password })];
                    case 1:
                        token = _b.sent();
